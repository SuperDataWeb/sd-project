...
document.write("<h1 style='width:100px;height:32px;'><img src=\"" + ctx + "/images/close_customer.gif\" border=\"0\" usemap=\"#Map\" onclick='hideMsgBox(event);' />");
...
document.write("</div>");
document.write("<img src='" + ctx + "/images/online_sm.gif'>");
document.write("</div>");
document.write("<div id='divMenu' onclick='OnlineOver();'  style='display : none;'><img src='" + ctx + "/images/arrow_left.gif' class='press' alt='在线客服，点击咨询'></div>");
document.write("</div>");

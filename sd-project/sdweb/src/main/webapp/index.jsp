...
<script type="text/javascript">
	var BASE_URL = '<%=request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath()%>';
  	...
  	function loadProductList(productType, param) {
  		var target = "product_" + productType + "/frame.do";
  		if (param == undefined)
  			param = 'product1';
	...
	<TBODY>
		...
		<TR>
			...
			<A href="Product/s/Product1.do" target=_self>
			 -->
			<A href="#" target=_self onclick="loadProductList('s')">
			<DIV class=navitemLast>中小企业管理</DIV>
			</A> <A href="#" target=_self onclick="loadProductList('m')">
			<DIV class=navitemLast>中型企业ERP</DIV>
			</A> <A href="#" target=_self onclick="loadProductList('b')">
			<DIV class=navitem>企业级ERP</DIV>
			</A> <A href="#" target=_self onclick="loadProductList('industry')">
...
<TABLE class=nfooter>
	<TBODY>
		<TR>
			<TD>广州速达软件省级总经销—广州沃迪信息科技有限公司版权所有1999-2016 经营许可证号:粤ICP备12059032号-1 <br>
			销售电话：020-85589742，技术电话：020-38471330 总机：400-0828-868

			...
			<tr>
				...
				<br /> <span class="ind_hg"> Copyright &copy; 2002-2011
					...
					<span class="STYLE6">联系电话：<span class="STYLE13">400-082-8868</span>
						...
						<!-- 
						<a
						href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=12361918&site=qq&menu=yes  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?'))window.location='http://wpa.qq.com/msgrd?v=3&uin=12361918&site=qq&menu=yes'">
						<img src="suda/templets/new/images/qq.gif" alt="速达软件" width="23"
							height="16" border="0" /><strong><font color="#CC0000">12361918</font></strong></a>
						 -->
						备案/许可证编号：<a

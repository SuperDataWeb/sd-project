							...
							<table width=100% align=center cellpadding=3 cellspacing=0
								...
								<form name="product" id="product" method='post' action="saveProduct.do"	accept-charset="UTF-8">
									...
									<tr>
										...
										<td bgcolor='ffffff'>
										    <input name='price' type='text' style="width:300px;" value=''></td>
								    </tr>
									<tr>
										<td width='20%' height=25 bgcolor='ffffff'>用户数</td>
										<td bgcolor='ffffff'>
										    <input name='userNum' type='text' style="width:300px;" value='' ></td>
									</tr>
									<tr>
										<td width='16%' height=25 bgcolor='ffffff'>产品详细路径</td>
										<td bgcolor='ffffff'>
										    <input name='detailUrl' type='text' style="width:300px;" value=''></td>
								    </tr>
									<tr>
										<td width='16%' height=25 bgcolor='ffffff'>图片路径</td>
										<td bgcolor='ffffff'>
										    <input name='img' type='text' style="width:300px;" value=''></td>
								    </tr>
								    <tr>
									...
									<tr>
										...
										<td bgcolor='ffffff'>
										   <textarea cols='20' rows='5' name='module' style='width:300px;height:90px;'></textarea> </td>
									</tr>
									<tr>
										<td width='16%' height=25 bgcolor='ffffff'>描述信息</td>
										<td bgcolor='ffffff'>
										    <textarea cols='20' rows='5' name='description' style='width:300px;height:90px;'></textarea></td>
								    </tr>
								    <tr>
										<td width='16%' height=25 bgcolor='ffffff'>特色功能</td>
										<td bgcolor='ffffff'>
										    <textarea cols='20' rows='5' name='features' style='width:300px;height:90px;'></textarea> *多个特色功能用“|”分割</td>
								    </tr>
									<tr>
										<td width='20%' height=25 bgcolor='ffffff'>产品陈述</td>
										<td bgcolor='ffffff'>
											<textarea cols='20' rows='5' name='presentation' style='width:300px;height:90px;'></textarea>
										 </td>
									</tr>

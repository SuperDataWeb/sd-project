						...
						<td class="tdbk" valign="top" width="752">
							<table width=100% align=center cellpadding=3 cellspacing=0
								...
								<form name="productSeries" id="productSeries" method='post' action="saveProductSeries.do" enctype="multipart/form-data" accept-charset="UTF-8">
								    <input type="hidden" name='id' value="${productSeries.id }">
									<tr>
										<td width='16%' height=25 bgcolor='ffffff'>产品系列名称</td>
										<td bgcolor='ffffff'><input name='seriesName' type='text' style="width:300px;" value='${productSeries.seriesName }'> </td>
									</tr>
									<tr>
										<td width='16%' height=25 bgcolor='ffffff'>别名</td>
										<td bgcolor='ffffff'>
										    <input name='alias' type='text' style="width:300px;" value='${productSeries.alias }'> *为了首页产品系列选项卡而设置</td>
								    </tr>
									<tr>
										<td width='20%' height=25 bgcolor='ffffff'>简要描述</td>
										<td bgcolor='ffffff'>
										    <input name='simpleDesc' type='text' style="width:300px;" value='${productSeries.simpleDesc }' > *为了首页产品系列选项卡而设置</td>
									</tr>
									<tr>
										<td width='16%' height=25 bgcolor='ffffff'>图片路径</td>
										<td bgcolor='ffffff'>
										    <input name='img' type='text' style="width:300px;" value='${productSeries.img }'>
									...
									<tr>
										...
										<td bgcolor='ffffff'>
										<textarea cols='20' rows='5' name='description' style='width:300px;height:90px;'>${productSeries.description }</textarea> *多个描述信息用“|”分割</td>
								    </tr>

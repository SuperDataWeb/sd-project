...
<script src="http://qiao.baidu.com/site/886/4e9275315db365e8bfde1fe0e12128f9/b.js"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="4">
								<tr>
									<td class="hg" style="padding-top: 8px">
											...
											<tbody>
												<tr>
													...
													<td style="width: 686px">
														采购开单、采购收货、估价入库、采购付款、采购退货、现款采购</td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												...
												<tr>
													...
													<td style="width: 686px">
														凭证录入、凭证审核、凭证查找、凭证登账、结转损益、期未结账</td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
										...
										<div>
											网店销售汇总表，网店销售明细表，物流费用汇总表，物流费用明细表，网店商品销售排行表，网店经营成果预览表</div>
										<div>&nbsp;</div>
										<div>
									...
									<br />
										<div id="ckepop">
											<span class="jiathis_txt">分享到：</span> <a
												...
												href="javascript:if(confirm('http://www.jiathis.com/share'))window.location='http://www.jiathis.com/share'"
												class="jiathis jiathis_txt jiathis_separator jtico jtico_jiathis"
												target="_blank">更多</a> <a class="jiathis_counter_style"></a>
										</div> <script type="text/javascript"
											src="../../../../../../v2.jiathis.com/code_mini/jia.js"
											charset="utf-8"></script> <br /> <br />
										<p class="hg">
											...
											<tr>
												<td width="51" height="22"><a
													href="tencent://message/?uin=1601331518&amp;Site=速达软件咨询&amp;Menu=yes"><img
														src="suda/templets/new/images/pa.gif" width="51"
														height="16" style="border: 0" /></a></td>

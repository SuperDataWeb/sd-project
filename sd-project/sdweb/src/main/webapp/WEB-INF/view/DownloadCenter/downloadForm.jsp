...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=340 align=center>
  <TBODY>
    <TR>
      ...
      href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=1539672881&site=qq&menu=yes'))window.location='http://wpa.qq.com/msgrd?v=3&uin=1539672881&site=qq&menu=yes'"

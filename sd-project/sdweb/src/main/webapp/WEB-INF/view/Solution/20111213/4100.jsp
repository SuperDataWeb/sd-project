...
<BODY type="leaveMessage">
	<table cellpadding="0" cellspacing="15" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td height="50" align="center"><span class="title">销售电器的超市</span></td>
              </tr>
            </tbody></table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td height="26" align="center" bgcolor="#E7F1E8">作者：<a href="index.htm">www.superdata.com.cn</a>&nbsp; &nbsp;来源：suda &nbsp; &nbsp;时间2012-02-02&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=4100&amp;mid=0" type="text/javascript" language="javascript"></script>113 次</td>
                </tr>
              </tbody></table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
	...
	客户简介:<br>
	　　安徽省宁国县大华电器有限责任公司,是一家销售洗衣机，彩电，冰箱等电器的超市，它有两个店面。总部的这个店要装两个POS前台，另外一个分店也要装一个POS前台。现要上一款我们速达的软件，信息化经费要求不高于15000元，管理软件具备应有的进、销、存和简单的财务功能外，还有一些自己的要求。</p>
<p>
	具体的需求描述如下：<br>
	　　1、总部的财务能够随时查看到POS前台的销售情况。<br>
	　　2、以前用的是超市之星软件，但由于这款软件没有其需要的先进先出的核算方法，所以它要求现在上的软件要具有这个算法。<br>
	　　3、由于它销售商品时，是先和客户谈好价格，再定出销售价格出卖的,不像一般的超市的商品的价格那样稳定，要求软件能够在POS前台销售时随时更改价格。<br>
	　　4、在每个门店只是放着几台包装已打开的货品的样品，当顾客看中了这台样品后，由于外形上包装已经打开，顾客不要这个样品，这时超市就会把这个门店的这个样品悄悄地运回总部的仓库包装好，然后再当作是这个门店销售的商品运送到顾客那去。<br>
	　　5、每个门店的业务员要根据他的业绩算工资，所以该是哪个门店销售去的样品，就算哪个门店的销售额。<br>
	　　6、当这个门店的样品卖完了时，又要从总仓调出货品到门店当作样品，要求软件能够实现这个功能。</p>
<p>
	案例解析：<br>
	　　为大华电器推荐的产品是：<strong>3000xp网络</strong>5用户加一个远程POS端，花费一共为12800+365=13165元。服务实施费总价的10%，13165*10%=1316元，价格合计13165+1316=14481元</p>
<p>
	具体问题解决如下：<br>
	　　1、安装了远程POS后，数据可以实时传送到总部服务器上，然后在销售模块中有相关的报表可以查询到。但是不能随时查到，要做了POS日结以后才可以查看。<br>
	　　2、<strong>速达3000xp</strong>最新版(8.6的)就提供了先进先出算法<br>
	　　3、POS销售前台中的有个“优惠金额”功能，按Z键执行，或者通过其优惠单价的方法即可实现。但是要经过组长的授权才可以做到。<br>
	　　4、前一部分是客户内部的管理流程问题，需要客户用制度去解决。<br>
	　　5、关于业务人员的业绩查询可以通过报表查看到每个POS端的销售额。<br>
	　　6、可以建立几个分支机构，然后再建几个仓库，通过仓库调拨实现。业务员的工资可以按计件实现。</p>
<p>
	<strong>速达软件官网</strong>销售的<strong>速达</strong><strong>3000pro</strong>，<strong>速达</strong><strong>3000xp</strong>，<strong>速达</strong><strong>5000</strong>，<strong>速达</strong><strong>7000</strong>，都能很好的处理销售电器的超市解决方案</p>
<p>

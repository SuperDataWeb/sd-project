...
<BODY type="leaveMessage">
	<table cellpadding="15" cellspacing="0" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody><tr>
                <td align="center" height="50"><span class="title">汽车用品行业</span></td>
              </tr>
            </tbody></table>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
                  <td align="center" bgcolor="#E7F1E8" height="26">作者：<a href="index.htm">速达3000</a>&nbsp; &nbsp;来源：速达软件 &nbsp; &nbsp;时间2012-02-05&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=19&amp;mid=1" type="text/javascript" language="javascript"></script>128 次</td>
                </tr>
              </tbody></table>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
	...
	操 作 说 明<br>
	　　――汽车用品行业演示账套<br>
	　　基本信息：<strong>速达3000pro</strong> V8.5，管理员密码为空。适用汽车用品行业。</p>
<p>
	　　一、建帐设置说明<br>
	　　账套代号：sample1<br>
	　　企业名称：汽车用品行业演示账套<br>
	...
	　　是否小企业会计制度：否<br>
	　　是否结合使用进销存与帐务结合使用<br>
	　　会计科目长度结构：4-4-3-2-2-2<br>
	　　凭证字：收、付、转<br>
	　　账套启用日期：2006-1-1</p>
<p>
	　　注解：<br>
	　　说明3，本账套主要用于汽车用品的进销存业务演示，故选择“商品流通企业”；<br>
	　　说明6，为突出“进销存与财务一体化”的特色，此处设置为结合使用；<br>
	　　说明7，二级会计科目的长度与账套所能允许的往来单位数量密切相关，目前估计有少于10000个的客户或者供应商数量，故设置为4位，即最多可以录入9999个供应商或者客户资料；<br>
	　　说明9，以年度的第一个月份作为账套的启用月份，较具代表性，对接下来的统计工作也更直观，所以设置为2006-1-1。<br>
	　　以上设置，在建账完成后，都不允许更改。故，在设置时需慎重考虑。</p>
<p>
	　　二、账套初始化设置说明<br>
	　　1、往来单位编码设置说明：G01002，K01002<br>
	　　字母G、K分别代表供应商和客户，数字前两位01代表地区，后三位002代表该地区的供应商或客户顺序号。<br>
	　　2、货品编码设置说明：01030002，A0001<br>
	　　常规货品的编码为01030002，前两位01代表该货品所属一级类别，3～4位03代表该货品所属二级类别，最后四位代表该二级类别中的货品顺序号；<br>
	　　特殊用途商品（如礼包、虚拟货品）的编码为A0001，字母A代表货品的用途分类，后四位数字代表该类别中的货品顺序号。<br>
	　　初始化的其他需要注意的事项：<br>
	　　1、基础资料的excel导入：<br>
	　　通过整理成excel电子表格的形式，可以将货品资料和往来单位资料导入到账套中，减少繁琐的手工输入过程。同时应该注意excel表的格式，建议从演示账套中导出一份表格以参考格式，excel表中单元格的内容尽量避免使用特殊符号，半角逗号绝对不能出现。<br>
	　　2、货品资料中相关信息的说明：<br>
	　　货品资料的相关信息，如存货类型、货品属性、成本核算方法、加权价都必须在初始化状态时定义好。启用帐套后，上述信息都不允许修改或补充。<br>
	　　3、期初往来款的录入：<br>
	　　建帐时有期初往来款的，需要在初始化时在客户资料或供应商资料中的“实际欠款”中录入，其中，预收和预付应以负数录入。期初往来款在账套启用之后将不允许更改或补充。<br>
	　　4、期初库存的录入：<br>
	　　期初的库存必须在初始化货品库存中录入，期初有委托代销业务的必须在委托代销初始化中录入，期初有估价入库业务的也必须在估价入库初始化中录入。以上三项在账套启用后将不允许修改或补充。<br>
	　　5、现金银行开账余额的录入：<br>
	　　现金银行账户的期初余额必须在初始化时录入，账套启用后不允许修改或补充。<br>
	　　6、帐务初始化的数据录入：<br>
	　　帐务数据初始化时，“本年年初”一栏不需要填写，当填写“期初余额”和“本年累计”之后，系统会自动计算出本年年初数。<br>
	　　特别注意：当初始化完成，准备启用账套之前，建议先对初始化状态的账套做一次备份，方便日后万一发现初始化数据有误时恢复数据进行更改，再重新启用账套。从而免去重新建帐的重复工作。&nbsp;</p>
<p>
	<strong>速达软件官网</strong>销售的速达3000系列软件,<strong>速达</strong><strong>3000pro</strong>，<strong>速达</strong><strong>3000xp</strong>，<strong>速达</strong><strong>5000</strong>，<strong>速达</strong><strong>7000</strong>，都能很好的处理<u><u><font color="#0000ff">汽车用品行业</font></u></u>解决方案</p>
<p>

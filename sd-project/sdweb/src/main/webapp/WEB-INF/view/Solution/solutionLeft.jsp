...
<BODY type="leaveMessage">
	...
	<table class="bk" border="0" cellpadding="0" cellspacing="0"
		width="220">
		  ...
		  <tbody><tr>
		    <td colspan="2" style="padding-top:8px" height="23" valign="middle"><table width="100%" border="0" cellpadding="0" cellspacing="0">
		        <tbody><tr>
		          <td height="23"><font color="#006600">　　<img src="suda/templets/new/images/dg.jpg" height="11" width="11">&nbsp;<strong>解决方案</strong></font></td>
		          <td><font color="#006600">　<img src="suda/templets/new/images/dg.jpg" height="11" width="11">&nbsp;<strong>案例分析</strong></font></td>
		        </tr>
		        <tr>
		...
		<tr>
		  ...
		  <tr>
		    <td colspan="2" align="right" height="10" valign="middle">&nbsp;<br></td>
		  </tr>
		</tbody>

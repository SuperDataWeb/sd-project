...
<BODY type="leaveMessage">
	<table cellpadding="15" cellspacing="0" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody><tr>
                <td align="center" height="50"><span class="title">百货行业</span></td>
              </tr>
            </tbody></table>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
                  <td align="center" bgcolor="#E7F1E8" height="26">作者：<a href="index.htm">广州速达软件</a>&nbsp; &nbsp;来源：速达软件官网 &nbsp; &nbsp;时间2012-02-04&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=18&amp;mid=1" type="text/javascript" language="javascript"></script>127 次</td>
                </tr>
              </tbody></table>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody><tr>
	...
	一、行业属性设定<br>
	　　针对百货流通企业的特点，企业在设置行业属性时，可参照下面的设置参数：<br>
	　　1、所属行业及纳税性质<br>
	　　所属行业：商品流通企业<br>
	　　纳税性质：一般纳税人<br>
	...
	　　如果选择“<strong>进销存系统</strong>与<strong>账务系统</strong>结合使用”，所有进销存业务在单据保存后即自动产生凭证；<br>
	　　如果选择“<strong>进销存系统</strong>与<strong>账务系统</strong>分开使用”，进销存业务单据不能自动产生凭证，进销存系统与财务系统完全分开，所有凭证必须手工完成；<br>
	　　因为速达3000系列软件每月凭证最大数量有限制（7.1版本之前每月凭证最大数量9999张；7.1版本开始每月凭证数量增加到999999张），所以必须根据公司实际业务情况来决定，如果公司每月单据数量非常大，同时选择了结合使用，每张单据生成一张凭证，那么，当凭证数量达到最大数量的时候，该会计期间将无法再保存新的单据或凭证；同时凭证数量很大，导致凭证审核、登帐速度下降；<br>
	　　对于一般百货企业来讲，我们建议选择“进销存系统与账务系统结合使用”，因为一般百货企业日常业务量繁多，但是配备相关操作人员相对较少，在很多时候，员工都需要“身兼多职”，因此，为简化管理流程，提高工作效率，我们建议，进销存系统与账务系统结合使用。<br>
	　　3、科目级长<br>

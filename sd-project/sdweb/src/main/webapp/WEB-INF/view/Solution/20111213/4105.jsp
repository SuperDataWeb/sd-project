...
<BODY type="leaveMessage">
	<table cellpadding="0" cellspacing="15" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td height="50" align="center"><span class="title">远程连锁企业解决方案</span></td>
              </tr>
            </tbody></table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td height="26" align="center" bgcolor="#E7F1E8">作者：<a href="index.htm">广州速达</a>&nbsp; &nbsp;来源：速达软件官网 &nbsp; &nbsp;时间2012-02-05&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=4105&amp;mid=0" type="text/javascript" language="javascript"></script>111 次</td>
                </tr>
              </tbody></table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
	...
	一、概述<br>
	　　上个世纪后期，中国的许多小企业已经开始放弃前店后厂式的作坊型经营模式。随着中国加入世界贸易组织和全球经济一体化的不断深化，小企业做大市场已经成为一种趋势，跨市、跨省甚至做跨国生意的中国中小企业多如雨后春笋。<br>
	　　新的经营模式必然会带来许多新的管理难题，特别是如何能够跨越时空，从总部的角度真正做到对异地的分支机构或连锁店进行细致、及时而有效的管理，这已经成为目前跻身于大市场的中小企业家们的管理瓶颈。<br>
	　　速达远程连锁流通企业解决方案，结合连锁企业的现状和管理要求，对连锁企业的物流、资金流、信息流进行集成管理，彻底解决分支机构所有进销存，财务信息及时安全汇总，为总部提供决策支持，真正实现将异地分支连锁处于近在咫尺的管理中，实现总部与分支机构一体化管理。<br>
	　　二、目标客户<br>
	　　流通企业的异地连锁店，加盟店<br>
	　　三、产品设计思想<br>
	　　产品是以远程连锁流通企业的管理要求为目标设计的软件，是联结连锁企业总部与各远程分支机构之间的桥梁、通过速达远程流通连锁企业解决方案，总部可以对各远程分支机构进行统一管理，集中控制，机构可以在总部的政策范围内灵活决策。<br>
	　　速达远程连锁流通企业解决方案， 同时充分考虑到企业运营的经济性，总部，分支机构均可在本地局域网实现管理操作，无须专门设置宽带联网、大力减少企业不必要的开支、<br>
	　　四、解决问题<br>
	　　速达远程连锁流通企业解决方案为总部，远程分支机构后台，门店前台提供了一体化解决方案、具体体现在以下方面:<br>
	　　1、总部与分支数据交流总部通过资料发送，异地分支通过资料下载更新基础资料，使异地分支资料与总部保持一致。异地分支通过数据上传，总部通过数据接收，使总部能够接异地分支业务数据，为总部提供决策支持，实现总部与分支一体化管理。<br>
	　　2、门店前台(POS销售前台)功能模块， 实现了零售业务的信息化管理。<br>
	　　3、网络数据中心平台的设立，使人员无论何时何地都能通过INTERNET查看总部与分支业务数据。方便企业决策查询的及时性。<br>
	　　4、提高效率，降低误差。<br>
	　　总部与异地分支之间的数据交流，大大减少了企业管理信息的失真或者延迟的问题，避免了数据的重复录入、纸面工作的差错与滞后等问题。<br>
	　　5、价格政策，灵活多样。<br>
	　　五、典型应用流程<br>
	　　速达远程连锁流通企业解决方案由采购、销售、仓存、存货核算、集团分销、销售前台（pos）系统、帐务系统等系统组成，各系统无缝联接，实现总部与分支机构一体化管理。<br>
	　　按使用部门可以分为总部运用，分支机构运用及门店前台运用三部门。<br>
	　　总部包含进货、销售、门店前台(POS销售前台)，现金银行、帐务系统、工资核算、分支管理、数据传输、网络数据中心、系统维护，除对总部内部进行完整的管理外，并根据各分支机构的不同属性，对分支机构进销存、财务数据进行分析处理，利用网络数据中心平台及时掌握各分支机构的每一步运作，为总部决策提供全面科学的数据依据。<br>
	　　门店前台(POS销售前台)运用主要包括使用PC机进行开票收银管理，如利用条码扫描设备自动识别商品，打印销售小票，收款，VIP卡处理，挂单，前台交班处理，支持客显，钱箱，数据上传管理等功能。<br>
	　　分支机构根据分支独立核算与非独立核算的不同性质，分为进货，销售， 门店前台(POS销售前台)，仓库，现金银行，数据传输功能模块(独立核算分支还包帐务系统，工资核算等模块)，实现分支日常业务处理，自动生成各种业务统计报表，为分支管理提供数据支持。</p>
<p>

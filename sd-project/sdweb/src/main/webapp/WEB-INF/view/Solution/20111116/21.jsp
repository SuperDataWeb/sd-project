...
<BODY type="leaveMessage">
	<table cellpadding="0" cellspacing="15" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td height="50" align="center"><span class="title">信息化带动工业化 企业发展的关键</span></td>
              </tr>
            </tbody></table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td height="26" align="center" bgcolor="#E7F1E8">作者：<a href="index.htm">速达</a>&nbsp; &nbsp;来源：速达软件 &nbsp; &nbsp;时间2012-02-05&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=21&amp;mid=1" type="text/javascript" language="javascript"></script>118 次</td>
                </tr>
              </tbody></table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
	...
	自从党的十六大提出"信息化带动工业化"的发展目标后，广大企业以饱满的热情从事信息化建设。<strong>ERP</strong>（企业资源计划）是企业信息化建设的主导系统，中国企业对于它的认识，已经由过去的陌生发展到今天的熟悉。但很多机构和媒体都认为上<strong>ERP</strong>项目失败率很高，企业风险过大，甚至有人说"上ERP企业是找死；不上ERP企业是等死".这样的观点确实困扰了很多人，使很多有进取心的企业在信息建设上裹足不前。因此我们有必要向大家解释一下ERP项目成败的因由，特别是当企业第一次实施ERP项目时应注意的环节。</p>
<p>
	　　首先我们应有一个清楚的认识，那就是ERP并不神秘，并不是高不可攀的事物，而恰恰它要解决企业遇到的最实际问题。ERP较其它管理信息系统有两个明显特征。</p>
<p>
	　　一是信息高度集成，<strong>ERP</strong>能有效地将企业的生产管理、销售、财务、客户关系、采购、人力资源等各种管理模块集成在一起，形成一个庞大的系统。ERP将企业各种管理信息存入在统一的一个数据库内，这样就实现了企业信息的共享，从而提高了企业各级组织内部有效的协作和快速反应。</p>
<p>
	　　二是实时在线管理，企业总部可以通过ERP对各级分支进行网上业务审批和远程监控，下级分支也可以通过ERP查询总部各类信息，这就是实时在线管理，因此ERP能与Internet高度地接合，并且有很强的数据交换和通信能力。由此可见，ERP所具有的明显优势是无法比拟的，企业选择ERP是历史发展的必须。</p>
<p>
	　　不容否认，的确有许多企业实施ERP的效果不尽人意。究其根本原因，就是企业在实施前过于理想化，缺乏对信息化建设的知识和经验，往往忽视ERP实施中的关键问题。一是实施企业没有提出十分明确、周详的管理需求，缺乏与软件提供商之间的充分协商。很多企业在实施ERP的调研阶段，并没有进行充分的论证，只是简单地向软件提供商提出了一些笼统的需求，但当真正见了软件以后，原先那些没有想到和忽视或者是两方理解错了的问题就会出现了。当出现这样问题后，企业和软件提供商之间很可能会相互埋怨，要么造成工期和费用的扩大，要么致使项目无法正常进行下去。这里面的根本原因是企业管理软件是由底层源代码组成的，要改变其中一部分，其它相关联的部分也要改动，其工作量是非常巨大的，据测算如修改一套软件15％以上的源代码，软件提供商的工作量就不会小于重新开发一套。实施ERP有点像盖大楼，工程没有开工，设计图纸可以任意改动，但是当大楼盖起来以后，再想去修改它，就会变得非常的困难。国外先进企业由于管理相对比较规范并且实施信息化比较早，企业的管理系统一般都换了3～5代，他们很清楚原先的系统有什么不足之处，所以他们在实施新系统之前一般会提出十分明确的需求。由于中国企业大都是第一次实施信息化建设，一下子要拿出十分专业和详尽的需求设计确实很难，第二个会造成企业实施ERP失败的原因，是企业轻视了下属员工对系统的抵触心理。</p>
<p>
	　　ERP不是一套简单的<strong>管理软件</strong>，它是企业"一把手工程"，它要实现一把手对企业管理的规范化和透明化，所以ERP真正的使用者是企业决策者和主要管理层。ERP并不是仅仅为了方便每个员工的工作而设计出来的，更重要的是为了实现企业一把手的管理目标，它对员工的工作有很强的约束力。从这个意义上讲，员工是不喜欢ERP的，因为他们不希望受到约束和控制；而且ERP的实施可以实现企业管理流程的改变，原先复杂的组织结构变得简单，原有的时空距离不复存在，这必然又涉及到很多员工的切身利益；而且有些员工天生就害怕新生事物、害怕使用计算机，所以他们会用各种理由推脱责任或把一些枝节的小问题无限地放大。</p>
<p>
	　　 通过前面的分析论述，大家可以看出企业实施ERP是有一定难度的，但对于发展中的广大中国企业必须要过这一关，这一关闯不过去，企业的现代化管理就无法实现。为了让第一次实施ERP的企业少走弯路，我们建议企业要注意实施过程中两个关键环节，一是软件的选型，二是员工培训。</p>
<p>

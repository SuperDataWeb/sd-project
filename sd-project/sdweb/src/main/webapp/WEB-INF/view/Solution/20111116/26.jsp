	...
	<table cellpadding="0" cellspacing="15" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td height="50" align="center"><span class="title">产品升级应用案例</span></td>
              </tr>
            </tbody></table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td height="26" align="center" bgcolor="#E7F1E8">作者：<a href="index.htm">广州速达软件</a>&nbsp; &nbsp;来源：速达软件官网 &nbsp; &nbsp;时间2012-02-05&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=26&amp;mid=1" type="text/javascript" language="javascript"></script>101 次</td>
                </tr>
              </tbody></table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
...
<p>
	...
	　　1、在3000PRO里面有导入导出功能，能把<strong>速达3000STD</strong>里面的基础资料导入到帐套里面，而在<strong>速达3000STD</strong>里面只有导出没有导入功能。<br>
	　　2、<strong>速达3000PRO</strong>是一款<strong>进销存和财务相结合</strong>的软件，客户可以根据需要选结合使用还是分开使用。<br>

...
<BODY type="leaveMessage">
	<table cellpadding="15" cellspacing="0" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td height="50" align="center"><span class="title">汽车美容行业</span></td>
              </tr>
            </tbody></table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td height="26" align="center" bgcolor="#E7F1E8">作者：<a href="index.htm">www.superdata.com.cn</a>&nbsp; &nbsp;来源：suda &nbsp; &nbsp;时间2012-02-02&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=4101&amp;mid=0" type="text/javascript" language="javascript"></script>167 次</td>
                </tr>
              </tbody></table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
	...
	客户简介：<br>
	　　德阳车之友汽车俱乐部位于德阳市岷江西路二段76号（二重加油站旁），是一家专业从事汽车美容、装饰、车险代理、洗车的公司，随着公司的不断壮大，代理产品越来越多，公司的管理上要求销售部能迅速准确的掌握目前库存情况并且报送相关报表，财务部及时报送相关报表，对此作出以下 管理软件需求：<br>
	　　1.公司内部有三台电脑使用，另外有一个工作端不在局域网内；<br>
	　　2.统计公司自用材料；<br>
	　　3.对采购代理的产品进行统计，包括采购和退货；<br>
	　　4.对每天的销售进行统计，统计现金销售及转帐销售；<br>
	　　5.对每天的销售成本进行统计；<br>
	　　6.代理商进行结款时，根据产品在仓库的数量进行结款，即卖了的才结款。要求能查询一个供应商供货库存数量金额情况（同一个商品可能在多个供应商处采购）；<br>
	　　7.采购退货的单价高于采购价，中间的价差处理；<br>
	　　8.随时查看库存数量金额，盘点管理；<br>
	　　9.货品核算需要采用个别计价法。</p>
<p>
	解决方案:<br>
	　　1.采用<strong>速达3000系列</strong>网络版+远程<strong>ONLINE客户端</strong>。<br>
	　　2.通过仓库领料单进行公司自用材料领用。<br>
	　　3.通过采购系统报表可对采购及采购退货进行统计，过滤报表时选 “单据类型”。<br>
	　　4.通过销售系统报表可对销售进行统计，过滤报表时选 “单据类型”过滤。<br>
	　　5.可查看销售毛利报表。<br>
	　　6.由于库存货品是不分供应商的，因为变通处理，将货品采用批号管理，同一个供应商供的货采用同一个批号。<br>
	　　7.中间差价可做到其他收入中。<br>
	　　8.可随时查看帐面库存报表，数量金额都有。<br>
	　　9.<strong>3000PRO</strong>及以上产品都具有个别计价法，增加货品资料时选择“个别计价”成本核算方法就可以。</p>
<p>

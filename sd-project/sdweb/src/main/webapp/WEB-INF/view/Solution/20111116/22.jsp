...
<BODY type="leaveMessage">
	<table cellpadding="0" cellspacing="15" border="0" align="center" width="100%">
        ...
        <tbody><tr>
          <td class="hg" height="174" valign="top" width="729"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tbody><tr>
                <td height="50" align="center"><span class="title">制造企业管理解决方案</span></td>
              </tr>
            </tbody></table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                  <td height="26" align="center" bgcolor="#E7F1E8">作者：<a href="index.htm">suda</a>&nbsp; &nbsp;来源：www.superdata.com.cn &nbsp; &nbsp;时间2012-02-05&nbsp; &nbsp;阅读：
                   <script src="/suda/plus/count.php?view=yes&amp;aid=22&amp;mid=1" type="text/javascript" language="javascript"></script>210 次</td>
                </tr>
              </tbody></table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
	...
	一、背景及解决方案综述<br>
	　　1、<strong>生产加工行业</strong>环境分析<br>
	　　中国加入WTO后，以其市场和资源优势逐渐变成全球生产加工中心，生产加工企业在全球经济一体化大环境下随着国家产业结构调整，积极参与国际分工，扩大市场容量，提升管理水平，大大地加快了行业发展步伐。与此同时，企业也面临着与之俱来的风险与挑战：<br>
	　　（一）&nbsp; 全球经济一体化（全球生产加工、全球采购、全球市场营销）使得行业竞争态势发生根本变化。<br>
	　　（二）&nbsp; 产品的个性化特色显著，品种剧增。过多的SKU将导致生产和物流成本升高，利润空间进一步缩小。<br>
	　　（三）&nbsp; 交货准时性要求增高，交货周期缩短，订单变更次数增多。<br>
	　　（四）&nbsp; 生产加工行业供应链复杂程度高，外部供应链的协同和内部供应链的集成水平要求均较高。<br>
	　　（五）&nbsp; 国内生产加工行业多属传统行业，在技术、管理、市场运作水平上存在明显的不平衡，行业分布的地域性特点较显著，但行业地域分布中具备完整产业链的产业群落尚不普遍，这将导致企业间物流成本增加，企业利润水平将受到一定影响。</p>
<p>
	二、&nbsp; 行业特点、管理问题和管理应用分析<br>
	　　(一)、&nbsp; 行业特点<br>
	　　生产加工业根据其生产过程的特点可分为两大类：离散生产加工和流程生产加工。</p>
<p>
	　　1、&nbsp; 典型的离散生产加工业主要从事单件、小批量生产、适合于面向订单的生产组织方式。代表行业是机械加工、电子元器件生产加工、汽车、服装、家具、五金、医疗设备、玩具等。<br>
	　　1)&nbsp; 离散生产加工企生产周期较长，产品结构复杂，工艺路线和设备配置非常灵活，临时插单现象多，零部件种类繁多。<br>
	　　2)&nbsp; 面向订单的离散生产加工业的生产设备布置不是按产品而通常按照工艺进行布置的。<br>
	　　3)&nbsp; 所用的原材料和外购件具有确定的规格，产品结构可以用树的概念进行描述，最终产品是由固定个数的零件或部件组成，形成非常明确和固定的数量关系。<br>
	　　4)&nbsp; 产品的质量和生产率很大程度依赖于工人的技术水平，自动化主要在单元级，例如数控机床、柔性生产加工系统等。<br>
	　　5)&nbsp; 通过加工或装配过程实现产品增值，整个过程不同阶段产生若干独立完整的部件、组件和产品。<br>
	　　6)&nbsp; 因产品的种类变化多，非标产品较多，要求设备和操作人员必须有足够灵活的适应能力<br>
	　　7)&nbsp; 通常情况下，由于生产过程可分离，订单的响应周期较长，辅助时间较多。</p>
<p>
	　　2、&nbsp; 流程造企业的典型行业：重复生产的行业主要有：家电产品、各种电器等，常常表现为流水线的方式；连续生产的行业主要有：化工、食品、饮料、制药、烟草等，常常通过管道进行各工序之间的传递。<br>
	　　1)&nbsp; 设备产能固定，计划的制定相对简单，常以日产量的方式下达，计划也相对稳定。<br>
	　　2)&nbsp; 对配方管理如安全性、保密性等的要求很高，但不象离散生产加工企业有准确的BOM。<br>
	　　3)&nbsp; 工艺固定，按工艺路线安排工作中心。工作中心是专门生产有限的相似的产品，工具和设备为专门的产品而设计，专业化特色较显著。<br>
	　　4)&nbsp; 生产过程的关键控制点是物料的数量、质量和工艺参数。人员技术水平的影响不大，生产过程的控制自动化程度较高，因为工作流程是自动的，生产管理的复杂程度相对较低，但对设备管理维护的要求较高。<br>
	　　5)&nbsp; 生产过程中常常出现联产品、副产品、等级品。<br>
	　　6)&nbsp; 物料从一个工作地到另一个工作地的转移主要使用机器传动，有少量在制品库存。</p>
<p>
	　　(二)、&nbsp; 管理问题<br>
	　　从企业内部供应链运作和行业特征来看，生产加工企业的核心问题集中体现在以下几个方面：　　<br>
	　　1)&nbsp; 计划管理<br>
	　　外部环境使得需求经常处在变化和波动之中，生产加工系统中人、机、料、法、环每个因素的变动都可能对生产计划的执行产生影响。因此对资源进行配置、业务进行预测的计划的制定就显得较复杂。<br>
	　　2)&nbsp; <strong>成本管理</strong><br>
	　　生产加工行业工序繁多，半成品、成品、在制品成本的核算、预测、控制涉及大量的资料，这些成本信息的时效性、准确性对企业财务核算和经营决策至关重要，目前多数生产加工企业的成本管理尚处在较粗放的阶段。<br>
	　　3)&nbsp; <strong>库存管理</strong><br>
	　　由于生产计划的不确定性及对库存物料的实时情况把握的缺乏，往往造成库存物料呆滞和生产所需物料缺货、不配套现象同时并存。<br>
	　　4)&nbsp; 物料供应<br>
	　　对生产加工业来讲，采购成本占整个产品成本的比重很大，因此加强物料采购计划和资金预测，使采购过程透明化，有效地规避采购风险对企业来讲非常重要，也是企业采购管理中较簿弱的环节。<br>
	　　5)&nbsp; 销售管理：<br>
	　　销售管理的作用是不断缩短订单响应时间，降低企业运作成本，准时交付，达到高的客户满意度。生产加工企业在销售管理中最突出的问题是：客户信息散乱，预测准确率低，价格管理混乱和信用风险管理薄弱。</p>
<p>
...
<p>
	...
	<a class="jiathis_counter_style"><span title="累计分享0次" id="jiathis_counter_43" class="jiathis_button_expanded jiathis_counter jiathis_bubble_style">0</span></a>
</div>
<script type="text/javascript" src="http://v2.jiathis.com/code_mini/jia.js" charset="utf-8"></script>
                    <br> <br>
                   <p class="hg"> <strong>速达软件（广州）销售服务中心</strong><br>
  地址：广州市番禺区大石588号金怡商业大厦301室<br>
  销售热线：400-034-3668<br>
  服务热线：020-85279086<br>
  维护专线：020-31001310<br>
  VIP 专线：18620607677　18127974810
</p><table width="300" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="22" width="51"><a href="tencent://message/?uin=1601331518&amp;Site=速达软件咨询&amp;Menu=yes"><img src="/suda/templets/new/images/pa.gif" style="border:0" height="16" width="51"></a></td>
    <td valign="bottom" width="80">：<a href="tencent://message/?uin=1601331518&amp;Site=速达软件咨询&amp;Menu=yes">1601331518</a></td>
    <td width="51"><a href="tencent://message/?uin=4000343668&amp;Site=速达软件咨询&amp;Menu=yes"><img src="/suda/templets/new/images/pa.gif" style="border:0" height="16" width="51"></a></td>
    <td valign="bottom">：<a href="tencent://message/?uin=4000343668&amp;Site=速达软件咨询&amp;Menu=yes">4000343668</a></td>
  </tr>
</tbody></table>
<p></p>

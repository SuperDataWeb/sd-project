...
<SCRIPT language=javascript type=text/javascript>
	...
	$(document).ready(function () {
		//$("#ctl00_ctl00_ctl00_ContentPlaceHolder1_ContentPlaceHolder1_ContentPlaceHolder1_Button1").click(function () {
		//	$('#indentForm').submitForm({
	    //        url: url("services/indentReq.do"),
	    ////        dataType: "text",
	...
	function submitForm() {
		var check = checkData();
		//alert("check result:" + check);
		if (check) {
			$.ajax({
				cache : false,
				type : "POST",
				url : url("services/indentReq.do"), //把表单数据发送到ajax.jsp
				data : $('#indentForm').serialize(), //要发送的是ajaxFrm表单中的数据
				async : false,
...
<BODY>
<FORM id=indentForm method=post name=indentForm>
<DIV class=tableTitle>申请购买 &nbsp; &nbsp; &nbsp; &nbsp;
<%--
<%=message%>
 --%>
...
<SCRIPT language=javascript type=text/javascript>
        var wrong = "<img src='<%= request.getContextPath()%>/images/icon_noteawake.gif' />";
        var right = "<img src='<%= request.getContextPath()%>/images/icon_right.gif' />";
        function _Obj(id) {
...
<TABLE style="BACKGROUND-COLOR: #cccccc; MARGIN-TOP: 15px; WIDTH: 68%"
	...
	<TBODY>
		<TR>
			<TD style="BACKGROUND-COLOR: white; WIDTH: 250px" align=right><STRONG>产&nbsp;&nbsp;&nbsp;&nbsp;品：</STRONG>
			</TD>
		...
		<TR>
			<TD style="BACKGROUND-COLOR: white" align=right><STRONG>备&nbsp;&nbsp;&nbsp;&nbsp;注：</STRONG>
			</TD>
		...
		<TR>
			...
			&nbsp;<INPUT
				...
				class=buttonbg value=提交 type=button onclick="submitForm()"

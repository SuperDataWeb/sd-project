...
<BODY type="leaveMessage">
	<table width="980" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="500" height="150" valign="middle">
			...
			<td valign="middle"><table width="100%" border="0"
					...
					<tr>
						<td height="27" align="center"><a
							href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=4000828868&site=qq&menu=yes'))window.location='http://wpa.qq.com/msgrd?v=3&uin=4000828868&site=qq&menu=yes'">我要咨询</a></td>

...
<P class=products_font><A href="<%= request.getContextPath()%>/Product/s/Product3.jsp" onclick="loadProductList('s','Product3')">&#8226;&nbsp;速达3000G-PRO</A>
 --%>
<P class=products_font><A href="#" onclick="loadProductList('s','product3')">&#8226;&nbsp;速达3000G-PRO</A>
<A href="#" onclick="loadProductList('s','product6')">&#8226;&nbsp;速达V3+.net-PRO工业版</A> <A
	href="#" onclick="loadProductList('s','product7')">&#8226;&nbsp;速达V3+.net-PRO商业版</A> <A
	href="#" onclick="loadProductList('s','product8')">&#8226;&nbsp;速达V30+.net工业版</A> <A
	href="#" onclick="loadProductList('s','product9')">&#8226;&nbsp;速达V30+.net商业版</A> <A
	href="#" onclick="loadProductList('s','product1')">&nbsp;更多...</A><BR>
</P>
</DIV>
<!--中型企业ERP -->
<DIV class=products_a>
...
<P class=products_font><A href="#" onclick="loadProductList('m','product1')">&#8226;&nbsp;速达V5+.net工业版</A>
<A href="#" onclick="loadProductList('m','product2')">&#8226;&nbsp;速达V5+.net商业版</A> <A
	href="#" onclick="loadProductList('m','product3')">&#8226;&nbsp;速达V50+.net工业版</A> <A
	href="#" onclick="loadProductList('m','product4')">&#8226;&nbsp;速达V50+.net商业版</A> <A
	href="#" onclick="loadProductList('m','product5')">&#8226;&nbsp;速达V500+.net工业版</A> <A
	href="#" onclick="loadProductList('m','product6')">&#8226;&nbsp;速达V500+.net商业版</A> <BR>
</P>
</DIV>
<!--企业级 ERP -->
...
<P class=products_font><A href="#" onclick="loadProductList('b','product1')">&#8226;&nbsp;速达V7+.net工业版</A>
<A href="#" onclick="loadProductList('b','product2')">&#8226;&nbsp;速达V7+.net商业版</A> <A
	href="#" onclick="loadProductList('b','product3')">&#8226;&nbsp;速达V70+.net工业版</A> <A
	href="#" onclick="loadProductList('b','product4')">&#8226;&nbsp;速达V70+.net商业版</A> <A
	href="#" onclick="loadProductList('b','product5')">&#8226;&nbsp;速达V700+.net工业版</A> <A
	href="#" onclick="loadProductList('b','product6')">&#8226;&nbsp;速达V700+.net商业版</A></P>
</DIV>
</DIV>
</DIV>
<!--中间广告 -->

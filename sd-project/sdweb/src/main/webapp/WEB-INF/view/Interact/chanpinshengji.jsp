  ...
  <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="8">&nbsp;</td>
        <td width="752" valign="top" class="tdbk">
        <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="30" valign="middle" style="padding-top:3px;">▎您当前的位置：首页&nbsp;>&nbsp;产品升级</td>
            </tr>
          </table>
          <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
...
<div style="padding-left: 30px">
	<ul class="ser_mmfont" style="list-style-image: url(imageget.ashx?/images/tu33.gif)">
		<li>
			全面优化业务流程，使产品应用更高效</li>
		<li>
			优化产品数据库结构，提高产品应用效率</li>
		<li>
			强大报表查询功能，提高报表输出速度</li>
		<li>
			适应新会计准则，完善企业管理制度</li>
	</ul>
</div>
<p>
	<br />
	&nbsp;&nbsp;&nbsp; &nbsp;通过产品升级，可最大限度地降低企业购买软件新版本的成本，并获取速达公司最新的技术成果，帮助您的企业优化内部管理，提高核心竞争力。</p>
					  </td>
                  </tr>
                </table>

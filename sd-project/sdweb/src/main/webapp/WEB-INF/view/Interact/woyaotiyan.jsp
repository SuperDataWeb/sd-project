	...
	　　为了令您能了解更多，我们为您提供速达软件免费体验及试用服务。您可以填写以下申请表单，我们会尽快与您联系。</p>
                ...
                <table width=100% align=center cellpadding=3 cellspacing=0 bgcolor='#FFFFFF'>
                  <form method='post' accept-charset="UTF-8"  action="saveOrder.do" onsubmit="return doValidate()">
                    <input type="hidden" name="orderType"  value="wyty"/>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td bgcolor='ffffff'><input name="contactUser" type='text' value=''></input>
                        <!--<font color="#FF6633">(*)</font>--></td>
                    </tr>
                    <tr>
                      <td width='16%' height=25 bgcolor='ffffff'>　公司名称</td>
                      <td bgcolor='ffffff'><input name='companyName' type='text' value=''></input>
                        </td>
                    </tr>
                    <tr>
                      <td width='16%' height=25 bgcolor='ffffff'>　联系电话</td>
                      <td bgcolor='ffffff'><input name='contactTel' type='text' value=''></input>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td bgcolor='ffffff'><input name='companyAddress' type='text' value='' size="45"></input>
                        </td>
                    </tr>
                    <tr>
			...
			<tr>
                <td width='20%' height=25 bgcolor='ffffff'>申请体验产品名称</td>
                <td bgcolor='ffffff'><input name='topic' type='text' value=''></input></td>
           </tr>
		<tr><td width='20%' height=25 bgcolor='ffffff'>备注留言</td><td bgcolor='ffffff'>
                    ...
                    <tr>
                      ...
                      <td bgcolor='ffffff'><input type='submit' name='submit'  value=' 提交 '></input>
                        <input type="reset" name="button" id="button" value=" 重置 "></input></td>
                    </tr>
                  </form>
                </table>
                <!--反馈表结束-->

	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td width="35" height="23" align="right" valign="middle"><img
				src="suda/templets/new/images/left_01.jpg" width="6" height="12" /></td>
			<td width="180" align="left" valign="middle">&nbsp;<a
				href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=4000828868&site=qq&menu=yes'))window.location='http://wpa.qq.com/msgrd?v=3&uin=4000828868&site=qq&menu=yes'">在线咨询</a></td>
		</tr>

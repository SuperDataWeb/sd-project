...
<!-- saved from url=(0051)http://www.superdata.com.cn/secondary/Overview.aspx -->
...
<DIV class=font24><IMG src="<%= request.getContextPath()%>/images/secondary/Overview_files/bd_pic2.jpg"></DIV>
<DIV class=main_tt>
...
<DIV class=font24><IMG src="<%= request.getContextPath()%>/images/secondary/Overview_files/bd_pic1.jpg"></DIV>
<DIV class=main_tt>
<DIV class=fleft>Builder-Ⅱ开发平台功能</DIV>
<A id=d name=d></A></DIV>
<DIV class=line>
<DIV class=pro_tb2><A href="#" onclick="loadBuilderList('Builder_ywlc')"><IMG
	src="<%= request.getContextPath()%>/images/secondary/Overview_files/pro2_tb1.jpg" width=70 height=73> </A></DIV>
<DIV style="PADDING-TOP: 8px" class=pro_wz2>速达Builder-II提供了完善功能模块定义功能，可操作性非常强，从根本上<BR>
满足企业定制系统功能的实际需要。<BR>
功能模块栏设置、功能模块定义、功能模块授权</DIV>
</DIV>
<DIV class=line>
<DIV class=pro_tb2><A href="#" onclick="loadBuilderList('Builder_DLDesign')"><IMG
	src="<%= request.getContextPath()%>/images/secondary/Overview_files/pro2_tb2.jpg" width=70 height=73> </A></DIV>
<DIV style="PADDING-TOP: 8px" class=pro_wz2>速达Builder-II提供非常直观的业务流程设计功能，用户可通过鼠标拖拉非<BR>
常容易就能完成业务流程定义，从而满足企业自定义业务流程的实际需要。<BR>
流程设计界面、业务流程设计</DIV>
</DIV>
<DIV class=line>
<DIV class=pro_tb2><A href="#" onclick="loadBuilderList('Builder_FMDefinition')"><IMG
	src="<%= request.getContextPath()%>/images/secondary/Overview_files/pro2_tb3.jpg" width=70 height=73> </A></DIV>
<DIV style="PADDING-TOP: 8px" class=pro_wz2>速达Builder-II作为高端V-ERP二次开发工具，通过“单据布局设计”功能<BR>
可以非常灵活地设计出不同单据布局。<BR>
单据布局设计界面、单据布局设计应用、单据布局授权</DIV>
</DIV>
<DIV class=line>
<DIV class=pro_tb2><A href="#" onclick="loadBuilderList('Builder_ARDesign')"><IMG
	src="<%= request.getContextPath()%>/images/secondary/Overview_files/pro2_tb4.jpg" width=70 height=73> </A></DIV>
<DIV style="PADDING-TOP: 8px" class=pro_wz2>Builder-II可通过报表设计工具快速设计出自己需要的分析报表；而且整个<BR>
设计过程采用向导形式，非常容易掌握，操作非常简单。<BR>
报表设计平台管理、报表设计向导、报表样式设计</DIV>
</DIV>
<DIV>
<DIV class=pro_tb2><A href="#" onclick="loadBuilderList('Builder_ATApplication')"><IMG
	src="<%= request.getContextPath()%>/images/secondary/Overview_files/pro2_tb5.jpg" width=70 height=73> </A></DIV>

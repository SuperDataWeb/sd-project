											...
											<tr>
												<td>
													...
													<div class="hg">
														...
														<ul>
															<li>
																ERP选型是企业ERP迈向成功的第一步，亿旭软件凭借上千家成功实施经验，实践出真知、为您的企业&ldquo;量体裁衣&rdquo;。</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>前期调研：我们为您推荐的产品满足现行企业管理需求同时也考虑企业未来发展的可扩展性、前瞻性等。</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>资深管理顾问为您梳理管理流程、提供专属解决方案、控制项目实施进度等。</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>帮助企业控制预算，只选对的，不选贵的，帮助企业选对软件，用上软件，用好软件。</li>
														</ul>
													</div> <br /> <br />
													<p class="hg">

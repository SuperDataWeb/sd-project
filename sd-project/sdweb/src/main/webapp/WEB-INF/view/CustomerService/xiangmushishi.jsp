							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td height="30" valign="middle" style="padding-top: 3px;">
										▎您当前的位置：<a href="../../../index.htm">首页</a> > <a href="../index.htm">客户服务</a> > <a href="index.htm">项目实施</a> >
									</td>
								</tr>
							</table>
											...
											<tr>
												<td>
													...
													<div class="hg">
														<p>&nbsp;</p>
														<ul>
															<li>资深实施顾问为企业制定专属项目实施计划。</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>实施准备：部门调研、资料准备等；</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>流程规划：职责权限授权、编码规则等；</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>系统培训：分部门分职责培训；</li>

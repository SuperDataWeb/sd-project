					...
					<tr>
						...
						<td class="tdbk" valign="top" width="752">
							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td height="30" valign="middle" style="padding-top: 3px;">您当前的位置：<a href="../../../index.htm">首页</a> > <a	href="customerService.do">客户服务</a> > <a href="dingZhiJieJueFangAn.do">定制解决方案</a> > </td>
								</tr>
							</table>
											...
											<tr>
												<td>
													...
													<div class="hg">
														<p>&nbsp;</p>
														<ul>
															<li>梳理企业管理需求，结合行业成功管理案例，为企业提供专属解决方案。</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>解决方案体验、选型：提供多种解决方案，制作专属演示数据，方便企业选型。</li>
														</ul>
														<p>&nbsp;</p>
														<ul>
															<li>深入分析企业各部门需求，确定方案，提出实施计划。</li>
														</ul>
													</div> <br /> <br />
													<p class="hg">

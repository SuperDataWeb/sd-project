					...
					<tr>
						...
						<td class="tdbk" valign="top" width="752">
							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td height="30" valign="middle" style="padding-top: 3px;">▎您当前的位置：<a href="../../../index.htm">首页</a> > <a href="../index.htm">客户服务</a> > <a href="index.htm">产品培训</a>	> </td>
								</tr>
							</table>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td>
													...
													<div class="hg">
														<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														根据用户的不同需求，我司提供多种培训方式，帮助客户掌握软件的使用。<br /> <br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1、
														现场培训：我司人员上门或客户到我司，专职技术人员现场培训；<br /> <br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、在线视频培训课程：定期更新，方便，快捷，适合基本操作；<br />
														<br />
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、公开课培训：每周六免费进行，客户按需选择；<br />
														<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														4、专属网络培训：根据客户需要，专场讲解；
													</div> <br /> <br />
													<p class="hg">

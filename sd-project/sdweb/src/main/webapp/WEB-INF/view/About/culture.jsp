...
<link href="suda/templets/new/css/lanmu.css" type="text/css"
	rel="stylesheet">
<script src="http://lxbjs.baidu.com/lxb.js?sid=1272542" async=""
	charset="utf-8" type="text/javascript"></script>
<script
	src="http://qiao.baidu.com/site/886/4e9275315db365e8bfde1fe0e12128f9/b.js"
												...
												<td>
													...
													<div class="hg">
														...
														<table border="0" cellpadding="0" cellspacing="0" width="100%">
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px"> 用户至上</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>&nbsp;<strong>速达</strong>集用户之所想，满足用户的期望，超乎用户的想象。
																	</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px"> 以人为本</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>&nbsp;人才是<strong>广州速达</strong>成功之本。在领导层的支持和信任下，大家的能力得到发挥和增强。
																	</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px"> 追求完美</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>
																		&nbsp;我们根据事实分析，雇用最优秀的员工和采纳最好的思想。为了找到真正合适的人才，我们会全面的了解应征者。脱颖而出者会成为公司的中流砥柱。</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px">&nbsp;&nbsp; 不断发展</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
														...
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px">&nbsp;&nbsp; 团队工作</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>&nbsp;团结协作。一支优秀的集体可以调动每个人的积极性，大家求同存异、共图发展。</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px">&nbsp;&nbsp; 用户决定质量</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>
																		&nbsp;用户对我们的才能、产品和服务的评价至关重要。因此我们以用户的满意度来衡量自己的成功。</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px"> 心动就行动</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>
																		&nbsp;对客户的需求及时做出反应也很重要。公司的成功很大程度取决于对市场变化和更新的适应。为了迎接这种挑战，我们要敏捷的思考和行动。</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px"> 关心和回报</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>
																		&nbsp;对员工诚挚的关怀是速达自始至终的准则，我们相信公司和员工之间信任和责任是成功的真正源泉。</td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="0" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td bgcolor="#f3f3f3" height="25"><strong><font
																			style="font-size: 13px"> 我们的使命</font></strong></td>
																</tr>
															</tbody>
														</table>
														<table border="0" cellpadding="11" cellspacing="0"
															...
															<tbody>
																<tr>
																	<td>
																		&nbsp;●许多公司把用户至上当作自己的信条，我们认为这是经营中最基本的要求，因此让用户有更多的&ldquo;惊喜&rdquo;才是我们的目标。<br />
																		&nbsp;●惊喜&rdquo;用户意味着激发他们的信心和热情；意味着在价格、表现、质量、特点和服务上为他们提供超值的服务。我们的成功就是鼓励公司的用户走出来为我们做宣传。<br />
																		&nbsp;●怎样让这种惊喜的感觉年复一年的持续下去？仅靠单一的产品、个人的思想是远远不够的，我们必须组织一个可以持续创新的集体。<br />
																		&nbsp;●我们要营造一个快速反应的环境，在这里大家彼此信任、鼓励、创新，发现不足积极改进。我们对工作充满激情，每个人的潜力都得到发展。<br />
																		&nbsp;●工作就是追求辉煌的成就，我们本着这样的原则为大家创造宽松的环境去争取更大的收获。
																	</td>
																</tr>
															</tbody>
														</table>
